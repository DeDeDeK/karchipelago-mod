...
SCHEMA = {
    ...
    "YakumonoAudio": TypeSpec(0x18, [
        f(0x00, "sfx_buf", "sounds", "buffer", 0x04, 4, 0x08),
    ]),
    "HurtCollision": TypeSpec(0x0C, [
        f(0x00, "hurt_buf", "hurtboxes", "buffer", 0x04, 4, 0x18),
    ]),

    "grRespawnNode": TypeSpec(0x08, [

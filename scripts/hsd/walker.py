...
class Walker:
    ...
    def visit_anim_buffer(self, off, hint):  return hint
    ...
    def visit_shapeset_blob(self, off, hint): return hint
    ...
    def visit_FogAdjDesc(self, off, _):     return 0x44

    def visit_Spline(self, off, _):         return 0x18
    def visit_ParticleJoint(self, off, _):  return 0x08

    def visit_Mtx(self, off, _):           return 0x30   # 4x3 floats inv_world
    def visit_MaterialDesc(self, off, _):  return 0x14
    def visit_TexLODDesc(self, off, _):    return 0x10
    def visit_PEDesc(self, off, _):        return 0xC
    def visit_TObjTev(self, off, _):       return 0x20
    ...
    def visit_envelope_or_joint(self, off, hint): return hint
    def visit_lobj_attn_blob(self, off, hint): return hint  # 0x0C/0x14 by LObj type

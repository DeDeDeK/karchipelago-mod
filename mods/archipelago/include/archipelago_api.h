...
typedef enum APItemId
{
    ...
    AP_PERM_PATCH_BOOST,            // PATCHKIND_ACCEL
    ...
    AP_ITKIND_BOOST,                // ITKIND_ACCEL
    AP_ITKIND_BOOSTDOWN,            // ITKIND_ACCELDOWN
    ...
    AP_ITKIND_COPYFREEZE,           // ITKIND_COPYICE
    ...
    AP_ITKIND_SENSORBOMB,           // ITKIND_SENSORBOMB
    ...
    AP_ITKIND_BOOSTFAKE,            // ITKIND_ACCELFAKE
    ...
    AP_PATCH_UNLOCK_BOOST,                 // PATCHKIND_ACCEL
    ...
    AP_ITEM_UNLOCK_SENSORBOMB,             // ITUNLOCK_SENSORBOMB
    ...
    AP_TOPRIDE_ITEM_UNLOCK_SPEED_UP,            // TRITEM_SPEED_UP
    AP_TOPRIDE_ITEM_UNLOCK_SPEED_DOWN,          // TRITEM_SPEED_DOWN
    AP_TOPRIDE_ITEM_UNLOCK_SPINNER,             // TRITEM_SPINNER
    AP_TOPRIDE_ITEM_UNLOCK_CHARGE_TANK,         // TRITEM_CHARGE_TANK
    AP_TOPRIDE_ITEM_UNLOCK_INVINCIBLE_CANDY,    // TRITEM_INVINCIBLE_CANDY
    AP_TOPRIDE_ITEM_UNLOCK_BUZZ_SAW,            // TRITEM_BUZZ_SAW
    AP_TOPRIDE_ITEM_UNLOCK_DRILL,               // TRITEM_DRILL
    ...
    AP_TOPRIDE_ITEM_UNLOCK_WALKY,               // TRITEM_WALKY
    AP_TOPRIDE_ITEM_UNLOCK_KRACKO,              // TRITEM_KRACKO
    ...
    AP_TOPRIDE_ITEM_GIVE_SPEED_UP,              // TRITEM_SPEED_UP
    AP_TOPRIDE_ITEM_GIVE_SPEED_DOWN,            // TRITEM_SPEED_DOWN
    AP_TOPRIDE_ITEM_GIVE_SPINNER,               // TRITEM_SPINNER
    AP_TOPRIDE_ITEM_GIVE_CHARGE_TANK,           // TRITEM_CHARGE_TANK
    AP_TOPRIDE_ITEM_GIVE_INVINCIBLE_CANDY,      // TRITEM_INVINCIBLE_CANDY
    AP_TOPRIDE_ITEM_GIVE_BUZZ_SAW,              // TRITEM_BUZZ_SAW
    AP_TOPRIDE_ITEM_GIVE_DRILL,                 // TRITEM_DRILL
    ...
    AP_TOPRIDE_ITEM_GIVE_WALKY,                 // TRITEM_WALKY
    AP_TOPRIDE_ITEM_GIVE_KRACKO,                // TRITEM_KRACKO

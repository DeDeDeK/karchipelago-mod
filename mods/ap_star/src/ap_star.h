...
// Returns 0 if it could not run, in which case the caller owes the mount and the
// completion sounds.
...
// handling_enabled has no option on the settings page and stays at its default.
